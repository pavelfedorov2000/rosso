...
app.productCardSlider = {
  ...
  description: 'your script description',
  init: function init() {
    var productCardThumbs = new Swiper(".product-thumbs-slider", {
      loop: true,
      spaceBetween: 15,
      direction: "vertical",
      slidesPerView: 4,
...
app.productReview = {
  ...
  description: 'your script description',
  init: function init() {
    document.querySelectorAll('.product-review__rating').forEach(function (rating) {
      var rate = rating.getAttribute('data-rating');
      var stars = rating.querySelectorAll('.rating__item');
...
$(document).ready(function () {
  ...
  $('.form input[type=file]').on('change', function () {
    ...
    $('.file-size').text("(".concat(Math.floor(arrayFiles[0].size * 0.0009765625), " \u041A\u0411)")); // переводим байты в килобайты и округляем до нижнего целого значения
  });
}); // pageup
